...
public class ObjectController : MonoBehaviour
{
    ...
    public Animator animatorDaPorta;
    ...
    {
        UsuarioClicouNoObjeto();
    }
    
    //Método que seleciona o frame do objeto escolhido
    public void UsuarioClicouNoObjeto()
    {

        Color corDoObjeto = imagemDoObjetoSelecionado.color;
        corDoObjeto = new Color(corDoObjeto.r, corDoObjeto.b, corDoObjeto.g, 1);
        imagemDoObjetoSelecionado.color = corDoObjeto;
        animatorDaPorta.SetTrigger("Abrir");
